...
def generate_embedding_plots(experiment_name, job_id, mode="FC"):
    ...
    emd, related_data = embeddings.get_intermediate_embeddings_for_dataset(model, dataset, mode, batch_size=1)
    # emd512 = emd[1]
...
# generate_embedding_plots("PNAConv_CoxPHLoss_month_24-11-2023", "WQ-xPbLcP0BqY6wmWF1VPQ")
# generate_embedding_plots("PNAConv_CoxPHLoss_month_24-11-2023", "e_mnebzfkFBnTMbd65DoKg")